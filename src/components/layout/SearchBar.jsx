...
const SearchBar = ({
  ...
  const handleSearch = (e) => {
    ...
    if (onSearch) {
      ...
      if (filters.deliveryProvider)
        params.set("provider", filters.deliveryProvider);
  ...
  const variants = {
    default:
      "bg-gray-100 focus-within:bg-white focus-within:ring-2 focus-within:ring-primary-500",
  ...
  return (
    <div className={`relative ${className}`}>
      <form
        ...
        className={`flex items-center gap-1 lg:gap-2 rounded-xl px-2 lg:px-4 py-2.5 transition-all ${variants[variant]}`}
      >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, deliveryProvider: e.target.value })
                  }
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, hasPickup: e.target.checked })
                    }
                    className="w-4 h-4 rounded border-gray-300 text-primary-500 focus:ring-primary-500"
                  />
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, hasDineIn: e.target.checked })
                    }
                    className="w-4 h-4 rounded border-gray-300 text-primary-500 focus:ring-primary-500"
                  />
