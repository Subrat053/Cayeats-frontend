    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 text-gray-300">
      ...
      <div className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Quick Links */}
          <div className="bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-orange-500/10 border border-orange-500/30 rounded-xl p-8 md:p-12 shadow-lg">
            <h2 className="text-3xl font-bold text-white mb-3">Quick Links</h2>
            <div className="h-1 w-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full mb-8"></div>
          ...
          {/* Contact Section */}
          <div className="mt-12 bg-gradient-to-r from-orange-500/10 to-orange-500/5 border border-orange-500/20 rounded-lg p-8 text-center">
